...
We are going to deal with a normalised value of expression. As such we calculate the counts per million values for the 
hESC-EPI dataset and convert the counts data from the output of the Kallisto pseudoalignment for the hESC-CM data into
counts per million.
