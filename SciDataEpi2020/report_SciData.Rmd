...
---
title: 'Scientific Data 2020. Analysis and code.'
...
output:
 rmarkdown::pdf_document:
   includes:
     fig_caption: yes
     in_header: RMD_materials/report_preamble.tex
urlcolor: blue
---
\sffamily
...
\rhead{V. R. Knight-Schrijver  \includegraphics[width=0.2\linewidth]{RMD_materials/header_logos.png}}
...
```{r, eval=F, message=T, echo=T, tidy=T}
...
```{r, eval=T, message=T, echo=T, tidy=F, fig.width=12, fig.height=8,  fig.align='center', out.width="1\\linewidth", fig.cap="\\label{fig1} Expressed gene detection saturation curves."}
...
```{r, eval=T, message=T, echo=T, tidy=F, fig.width=8, fig.height=3,  fig.align='center', out.width="1\\linewidth", fig.cap="\\label{fig2} Gene markers for cell line validation."}
# EPI DATASET   
...
```{r, eval=T, message=T, echo=T, tidy=F, fig.width=8, fig.height=8,  fig.align='center', out.width="0.8\\linewidth", fig.cap="\\label{fig3} Replicate correlation plots"}
...
We further refine this list to retain only proteins that are secreted by the EPI, and not those which are also 
secreted by the CMs (**Int.F1**). Additionally we filter out the proteins that are membrane-bound in both cell types (**Int.F2**).
...
```{r, eval=T, fig.width=15, fig.height=10,  fig.align='center', out.width="1\\linewidth", fig.cap="\\label{fig4} The top 10 differentially upregulated hits for both EPI and CM, linked by their interactome from stringDB"}
  interactome.dataframe <- Int.F2
